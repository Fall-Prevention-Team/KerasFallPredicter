...
def main():
    ...
    d4 = load_dataset(root + 'SA01/F01_SA01_R01.txt')
    d5 = load_dataset(root + 'SA01/F02_SA01_R01.txt')
    d6 = load_dataset(root + 'SA01/F03_SA01_R01.txt')
    d7 = load_dataset(root + 'SA01/F04_SA01_R01.txt')
    d8 = load_dataset(root + 'SA01/F05_SA01_R01.txt')
